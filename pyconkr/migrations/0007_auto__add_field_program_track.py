...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Program.track'
        db.add_column(u'pyconkr_program', 'track',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pyconkr.Track'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Program.track'
        db.delete_column(u'pyconkr_program', 'track_id')
    ...
    models = {
        u'pyconkr.program': {
            ...
            'track': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['pyconkr.Track']", 'null': 'True'})
        },
        u'pyconkr.room': {
